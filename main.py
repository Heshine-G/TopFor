...
def main():
    parser = argparse.ArgumentParser(description="Pipeline for NSAA AMBER parameter generation")
    ...
    parser.add_argument("--gmx", "-gmx", action="store_true", help="Also generate GROMACS-compatible files")
