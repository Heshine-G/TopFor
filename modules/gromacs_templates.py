# modules/gromacs_templates.py
from __future__ import annotations

import os


def write_top_mdp_files(output_dir: str, residue_name: str, forcefield_include: str = "amber99sb.ff/forcefield.itp") -> None:
    """
    Write minimal topol.top + em.mdp + md.mdp.

    Note:
    - The forcefield include is user/environment dependent in GROMACS.
    - We keep a default but allow override.
    """
    # --- topol.top ---
